...
// AV What kind of display is this? not the Yellow..

// AV - edited for https://www.lilygo.cc/products/t-display-s3
...
#define TFT_CS   15
#define TFT_DC    2
#define TFT_RST   5  // Or use -1 if reset is connected to 3.3V
...
#define TFT_X_OFFSET 0 // 35  // X-offset for 170x320 display
#define TFT_Y_OFFSET 0   // Y-offset for 170x320 display


// video config AV
#define TFT_SPICLK  40000000    // 40 Mhz. AV S3 doesn't cope with 80 Mhz

// #define TFT_CS   15
// #define TFT_DC  32
// #define TFT_RST 27
// #define TFT_BL  13    // don't set if backlight is hard wired
#define TFT_ST7789V  // define for ili9341, otherwise st7789 // AV TFT_ST7789V
...
#define BTN_COIN_PIN   14   // if this is not defined, then start will act as coin & start
#define BTN_LEFT_PIN   0
#define BTN_RIGHT_PIN  14
#define BTN_DOWN_PIN   14
#define BTN_UP_PIN     0
#define BTN_FIRE_PIN   0
